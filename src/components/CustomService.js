...
import { Shield, CheckCircle, Zap, Award, Clock, Users, Package, X, Send, Sparkles, Code, Palette, Wrench } from 'lucide-react';
...
export default function CustomServices() {
  ...
  const customServices = [
    { 
      icon: Code,
      name: t('customSolutionsServicesCustomSoftware'), 
      description: t('customSolutionsServicesCustomSoftwareDesc')
    },
    { 
      icon: Palette,
      name: t('customSolutionsServicesUiUxDesign'), 
      description: t('customSolutionsServicesUiUxDesignDesc')
    },
    { 
      icon: Wrench,
      name: t('customSolutionsServicesSystemIntegration'), 
      description: t('customSolutionsServicesSystemIntegrationDesc')
    },
    { 
      icon: Sparkles,
      name: t('customSolutionsServicesDigitalTransformation'), 
      description: t('customSolutionsServicesDigitalTransformationDesc')
    }
  ];
  ...
  const features = [
    {
      icon: Sparkles,
      title: t('customSolutionsFeaturesFullyCustomized'),
      description: t('customSolutionsFeaturesFullyCustomizedDesc')
    },
    {
      icon: Zap,
      title: t('customSolutionsFeaturesAgileApproach'),
      description: t('customSolutionsFeaturesAgileApproachDesc')
    },
    {
      icon: Award,
      title: t('customSolutionsFeaturesExpertCraftsmen'),
      description: t('customSolutionsFeaturesExpertCraftsmenDesc')
    },
    {
      icon: Shield,
      title: t('customSolutionsFeaturesQualityAssured'),
      description: t('customSolutionsFeaturesQualityAssuredDesc')
    }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
      <InquiryModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} serviceType="Custom" />
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="text-center">
            <div className="mb-8 inline-flex items-center gap-3 rounded-full bg-purple-100 px-6 py-3">
              ...
              <span className="text-sm font-semibold text-purple-700">{t('customSolutionsHeroCraftedForYou')}</span>
            </div>
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-gray-900 sm:text-7xl">
              {t('customSolutionsHeroTitle1')}
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">
                {t('customSolutionsHeroTitle2')}
              </span>
            </h1>
            <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-600 sm:text-xl">
              {t('customSolutionsHeroDescription')}
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                {t('customSolutionsHeroShareProject')}
              </button>
            </div>
            <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
              <div>
                <div className="text-4xl font-bold text-purple-600">100+</div>
                <div className="text-sm text-gray-600">{t('customSolutionsStatsCustomProjects')}</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-pink-600">98%</div>
                <div className="text-sm text-gray-600">{t('customSolutionsStatsSuccessRate')}</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-purple-600">15+</div>
                <div className="text-sm text-gray-600">{t('customSolutionsStatsExpertDevelopers')}</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-pink-600">24/7</div>
                <div className="text-sm text-gray-600">{t('customSolutionsStatsDedicatedSupport')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-4xl font-bold text-gray-900">
              {t('customSolutionsServicesTitle')}
            </h2>
            <p className="text-lg text-gray-600">
              {t('customSolutionsServicesDescription')}
            </p>
          </div>
          ...
          <div className="mt-12 rounded-3xl bg-gradient-to-r from-purple-600 to-pink-600 p-12 text-center shadow-2xl">
            <Code className="mx-auto mb-4 h-12 w-12 text-white" />
            <h3 className="mb-4 text-3xl font-bold text-white">
              {t('customSolutionsCtaDifferentChallengeTitle')}
            </h3>
            <p className="mb-8 text-lg text-purple-100">
              {t('customSolutionsCtaDifferentChallengeDesc')}
            </p>
            <button 
              onClick={() => setIsModalOpen(true)}
            ...
            >
              {t('customSolutionsCtaTellUsIdea')}
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-4xl font-bold text-white">
              {t('customSolutionsFeaturesTitle')}
            </h2>
            <p className="text-lg text-purple-100">
              {t('customSolutionsFeaturesDescription')}
            </p>
          </div>
          ...
          <div className="mt-16 rounded-3xl bg-white p-12 text-center shadow-2xl">
            ...
            <h3 className="mb-4 text-3xl font-bold text-gray-900">
              {t('customSolutionsCtaReadyToBuildTitle')}
            </h3>
            <p className="mb-8 text-lg text-gray-600">
              {t('customSolutionsCtaReadyToBuildDesc')}
            </p>
            <button 
              onClick={() => setIsModalOpen(true)}
            ...
            >
              {t('customSolutionsCtaStartProject')}
            </button>
          </div>
        </div>
      </section>
