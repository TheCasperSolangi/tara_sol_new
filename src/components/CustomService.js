          ...
          <div>
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-white relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-purple-100 text-sm">{t('modalSubtitle', { serviceType })}</p>
              </div>
            </div>
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-700">
                  {t('projectIdea')} <span className="text-red-500">*</span>
                </label>
                <textarea
                  required
...
export default function CustomServices() {
  ...
  const features = [
    {
      icon: Sparkles,
      title: t('fullyCustomized'),
      description: t('fullyCustomizedDesc')
    },
    {
      icon: Zap,
      title: t('agileApproach'),
      description: t('agileApproachDesc')
    },
    {
      icon: Award,
      title: t('expertCraftsmen'),
      description: t('expertCraftsmenDesc')
    },
    {
      icon: Shield,
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="text-center">
            <div className="mb-8 inline-flex items-center gap-3 rounded-full bg-purple-100 px-6 py-3">
              ...
              <span className="text-sm font-semibold text-purple-700">{t('craftedForYou')}</span>
            </div>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-8 text-center">
              <div>
                ...
                <div className="text-sm text-gray-600">{t('customProjects')}</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">{t('expertDevelopers')}</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-pink-600">24/7</div>
                <div className="text-sm text-gray-600">{t('dedicatedSupport')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 rounded-3xl bg-gradient-to-r from-purple-600 to-pink-600 p-12 text-center shadow-2xl">
            ...
            <h3 className="mb-4 text-3xl font-bold text-white">
              {t('differentChallengeTitle')}
            </h3>
            <p className="mb-8 text-lg text-purple-100">
              {t('differentChallengeDesc')}
            </p>
            <button 
              onClick={() => setIsModalOpen(true)}
